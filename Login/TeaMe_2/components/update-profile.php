<?php
    ...
    if(isset($_POST)){
        ...
        $sql3="UPDATE user SET user_firstname='$user_firstname',user_lastname='$user_lastname',user_profession='$user_profession',user_email='$user_email',user_password='$user_password',user_shortbio='$user_shortbio',user_dob='$user_dob',user_gender='$user_gender',user_country='$user_country' WHERE user_username = '$temp'";
